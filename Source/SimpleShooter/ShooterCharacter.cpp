...
float AShooterCharacter::GetHealthPresect() const
{
...
void AShooterCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis(TEXT("MoveRight"), this, &AShooterCharacter::MoveRigth);
...
void AShooterCharacter::MoveRigth(float AxisValue)
{
...
float AShooterCharacter::AddHealth(float& Healing)
{
	Health += Healing;
	if (Health > MaxHealth)
	{
